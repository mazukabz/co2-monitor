...
FIRMWARE_CHANGELOG = "Huge adaptive CO2 display - scale 7 for 3 digits, scale 5 for 4 digits, centered"
...
@app.get("/tunnel-setup.sh")
async def get_tunnel_setup_script():
    """Download SSH tunnel setup script for Raspberry Pi."""
    return Response(content=TUNNEL_SETUP_SCRIPT, media_type="text/x-shellscript")
